...
namespace senai.spmedicalgroup.webApi.Controllers
{
    ...
    {
        private IClinicaRepository _Repository { get; set; }

        public ClinicasController()
        {
            _Repository = new ClinicaRepository();
        }
        ...
        [HttpPost]
        public IActionResult Cadastrar(Clinica obj)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Atualizar(int id, Clinica obj)
        {
